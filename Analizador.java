...
public class Analizador {
	...
	// Método que calcula la aridad de los argumentos. Devuelve un entero
	...
	// Método que recibe un string, el cual corresponde a los antecedentes que se deben cumplir para legar a una meta,
	//  y separa el string y lo mete en un arreglo para facilitar su manipulación a la hora de realizar consultas.
...
// Método que recibe el string que ingresa el usuario y lo analiza metiendo en un arreglo únicamente los caracteres que son
// permitidos, para luego realizar una comparación.
...
//Método que recibe el string que ingresa el usuario y mete en un arreglo todos los caracteres ingresados por el usuario
//ya sean estos permitidos o no.
public String[] expresión_usuario(String usuario){
	...
	while(matcher2.find()){
	    ...
	    String tokenTipo4=matcher2.group(4);
		 ...
		 if(tokenTipo5!=null){
			// System.out.println("Puntuación: " + tokenTipo5);
			 result[i]=tokenTipo5;
		     i++; 
		 }
...
// Método que recorre un arreglo hasta encontrar una posición nula
...
public boolean analizadorsintacticoreglas(String [] array){
	...
	if ((array[0]!=null)&&(array[0].equals(minuscula)==true) && (validaNumeros(array[0])==false)){
		if ((array[i]!=null)&&(array[i].equals("(")==true)){
			i++;
			String mayuscula=array[i].toUpperCase();
			if ((array[i]!=null)&&((array[i].equals(mayuscula)==true) && (validaNumeros(array[i])==false))){
				i++;
				if ((array[i]!=null)&&(array[i].equals(",")==true)){
					i++;
...
public boolean analizadorantecedentes(int i,String [] array){
	if (array[i]!=null){
		...
		if ((array[i]!=null)&&((array[i].equals(minuscula)==true) && (validaNumeros(array[i])==false))){
			i++;
			if ((array[i]!=null)&&(array[i].equals("(")==true)){
				i++;
				String mayuscula=array[i].toUpperCase();
				...
				if ((array[i]!=null)&&((array[i].equals(mayuscula)==true) && (validaNumeros(array[i])==false))){
					...
					if ((array[i]!=null)&&(array[i].equals(",")==true)){
						...
						if((array[i]!=null)&&((array[i].equals(mayuscula)==true) && (validaNumeros(array[i])==false))){
							...
							if ((array[i]!=null)&&(array[i].equals(")")==true)){
								i++;
								if ((array[i]!=null)&&(array[i].equals(",")==true || array[i].equals(";")==true )){
									i++;
				...
				i--;
				if ((array[i]!=null)&&((array[i].equals("fail")==true) ||(array[i].equals("nl")==true))){
					i++;
					if ((array[i]!=null)&&((array[i].equals(",")==true) || (array[i].equals(";")==true ))){
						i++;
						analizadorantecedentes(i,array);
			...
			if ((array[1]!=null)&&(array[1].equals("("))) {
				...
				//	System.out.println(minuscula +" Minuscula");
					...
					//		System.out.println(array[6]+" ARRAYYYYYYYYYYYYY");
						...
						System.out.println("Error,el functor debe ser minuscula o número");
						return false;
					}
				} else {
					minuscula = array [2].toLowerCase();
